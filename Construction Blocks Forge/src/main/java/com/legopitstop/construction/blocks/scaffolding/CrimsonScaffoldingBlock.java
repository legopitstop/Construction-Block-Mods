...
public class CrimsonScaffoldingBlock extends Block implements IWaterLoggable {
    // field_235580_B_ -> FUNGUS
    // field_237214_y_ -> NETHER_WOOD
    public CrimsonScaffoldingBlock() {
    ...
    public static final VoxelShape field_220121_d;
    public static final VoxelShape field_220122_e;
    public static final VoxelShape field_220123_f = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 2.0D, 16.0D);
    public static final VoxelShape field_220124_g = VoxelShapes.fullCube().withOffset(0.0D, -1.0D, 0.0D);
    ...
    public CrimsonScaffoldingBlock(AbstractBlock.Properties properties) {
        super(properties);
    ...
    public static int func_220117_a(IBlockReader p_220117_0_, BlockPos p_220117_1_) {
        ...
        int i = 7;
        if (blockstate.isIn(ConstructionBlocks.CRIMSON_SCAFFOLDING.get())) {
        ...
        for(Direction direction : Direction.Plane.HORIZONTAL) {
            BlockState blockstate1 = p_220117_0_.getBlockState(blockpos$mutable.setAndMove(p_220117_1_, direction));
            if (blockstate1.isIn(ConstructionBlocks.CRIMSON_SCAFFOLDING.get())) {
    ...
    static {
        ...
        field_220122_e = VoxelShapes.or(CrimsonScaffoldingBlock.field_220123_f, field_220121_d, voxelshape6, voxelshape5, voxelshape8, voxelshape7);
    }
}