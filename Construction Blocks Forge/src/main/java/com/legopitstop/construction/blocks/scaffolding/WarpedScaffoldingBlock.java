...
public class WarpedScaffoldingBlock extends Block implements IWaterLoggable {
    // field_235580_B_ -> FUNGUS
    // field_237214_y_ -> NETHER_WOOD
    public WarpedScaffoldingBlock() {
    ...
    public WarpedScaffoldingBlock(Properties properties) {
        super(properties);
    ...
    public static int func_220117_a(IBlockReader p_220117_0_, BlockPos p_220117_1_) {
        ...
        int i = 7;
        if (blockstate.isIn(ConstructionBlocks.WARPED_SCAFFOLDING.get())) {
        ...
        for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate1.isIn(ConstructionBlocks.WARPED_SCAFFOLDING.get())) {
    ...
    static {
        ...
        field_220122_e = VoxelShapes.or(WarpedScaffoldingBlock.field_220123_f, field_220121_d, voxelshape6, voxelshape5, voxelshape8, voxelshape7);
    }
}